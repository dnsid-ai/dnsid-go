...
## type [AgentDetail](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L230-L255>)
...
### func [WaitForRegistryStatus](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1191>)
...
<a name="AgentError"></a>
## type [AgentEvent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L376-L383>)
...
## type [AgentListItem](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L205-L213>)
...
## type [AgentListResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L216-L219>)
...
## type [AgentRegistration](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L106-L116>)
...
## type [AgentRegistrationInput](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L86-L92>)
...
<a name="AgentState"></a>
## type [CanonicalRecordContentResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L40-L44>)
...
## type [ChallengeRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L295-L298>)
...
<a name="Config"></a>
## type [CreateAgentRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L132-L141>)
...
## type [CreateAgentResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L144-L153>)
...
<a name="DNSRecord"></a>
## type [EventListOptions](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L435-L438>)
...
## type [EventListResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L386-L389>)
...
## type [HTTPRegistryClient](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L504-L509>)
...
### func [NewRegistryClient](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L563>)

```go
func NewRegistryClient(baseURL string, transportConfig ...TransportConfig) (*HTTPRegistryClient, error)
```

NewRegistryClient creates an HTTP registry client for baseURL. Only HTTPS URLs are accepted for production use.

<a name="NewRegistryClientWithOptions"></a>
### func [NewRegistryClientWithOptions](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L584>)

```go
func NewRegistryClientWithOptions(baseURL string, opts ...RegistryClientOption) (*HTTPRegistryClient, error)
```

NewRegistryClientWithOptions creates an HTTP registry client with functional options. By default only HTTPS URLs are accepted. Use WithInsecureHTTP\(\) for local testing.

<a name="HTTPRegistryClient.CancelAgent"></a>
### func \(\*HTTPRegistryClient\) [CancelAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L902>)
...
### func \(\*HTTPRegistryClient\) [CanonicalRecordContent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L616>)
...
### func \(\*HTTPRegistryClient\) [ConfirmReady](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L919>)
...
### func \(\*HTTPRegistryClient\) [CreateAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L660>)

```go
func (c *HTTPRegistryClient) CreateAgent(ctx context.Context, req *CreateAgentRequest) (*CreateAgentResponse, error)
```

CreateAgent registers a non\-Live agent through the HTTP 201 flow. It rejects a request whose PublicKey contains private JWK members before anything is sent to the registry. When Environment is empty it defaults to "sandbox". Sandbox and zone registrations are registry\-managed even when Managed is false. Self\-managed registrations require an explicit production environment and a domain. Use CreateLiveAgent for tier="live".

<a name="HTTPRegistryClient.CreateLiveAgent"></a>
### func \(\*HTTPRegistryClient\) [CreateLiveAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L694>)
...
### func \(\*HTTPRegistryClient\) [GetAgentEvents](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L803>)
...
### func \(\*HTTPRegistryClient\) [GetAgentStatus](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L763>)
...
### func \(\*HTTPRegistryClient\) [GetIdentityRecord](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1146>)
...
### func \(\*HTTPRegistryClient\) [GetRegistration](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L771>)
...
### func \(\*HTTPRegistryClient\) [ListAgents](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L744>)
...
### func \(\*HTTPRegistryClient\) [ListExpiringAgents](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1157>)
...
### func \(\*HTTPRegistryClient\) [ListFlaggedAgents](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1163>)
...
### func \(\*HTTPRegistryClient\) [ListPendingAgents](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1169>)
...
### func \(\*HTTPRegistryClient\) [PrepareIssuance](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1061>)
...
### func \(\*HTTPRegistryClient\) [PrepareKeyRotation](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1081>)
...
### func \(\*HTTPRegistryClient\) [PublishSignature](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L629>)
...
### func \(\*HTTPRegistryClient\) [ReissueLiveProof](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L851>)
...
### func \(\*HTTPRegistryClient\) [RejectAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L907>)
...
### func \(\*HTTPRegistryClient\) [RetireAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L894>)
...
### func \(\*HTTPRegistryClient\) [RevokeAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L883>)
...
### func \(\*HTTPRegistryClient\) [SetAuthToken](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L550>)

```go
func (c *HTTPRegistryClient) SetAuthToken(token string) error
```

SetAuthToken updates the Bearer token on an existing client \(e.g. after refresh\). It returns an error if the client is configured for plaintext HTTP without WithInsecureHTTP.

<a name="HTTPRegistryClient.SubmitChallenge"></a>
### func \(\*HTTPRegistryClient\) [SubmitChallenge](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L822>)
...
### func \(\*HTTPRegistryClient\) [SubmitLiveProof](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L829>)
...
### func \(\*HTTPRegistryClient\) [SubmitPreparedEvent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1111>)
...
### func \(\*HTTPRegistryClient\) [SubmitSignature](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1151>)
...
### func \(\*HTTPRegistryClient\) [UnregisterAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L733>)
...
### func \(\*HTTPRegistryClient\) [VerifyAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L913>)
...
### func \(\*HTTPRegistryClient\) [VerifyDomainRemote](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1176>)
...
### func \(\*HTTPRegistryClient\) [WaitForStatus](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L1182>)
...
## type [IdentityRecordRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L258-L260>)
...
## type [IdentityRecordResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L263-L269>)
...
## type [KeyRotationPreparationRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L47-L50>)
...
## type [LifecycleResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L369-L373>)
...
## type [ListAgentsOptions](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L429-L432>)
...
## type [LiveAgentRegistrationInput](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L158-L164>)
...
## type [LiveChallengeTranscript](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L168-L176>)
...
## type [LiveProofReissueRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L320-L324>)
...
## type [LiveProofReissueResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L328-L336>)
...
## type [LiveProofRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L301-L310>)
...
## type [LiveProofResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L313-L317>)
...
## type [LiveProvisioningResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L181-L189>)
...
## type [OperationsAgent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L392-L403>)
...
## type [OperationsAgentListResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L406-L408>)
...
<a name="ParseError"></a>
## type [PreparedRegistryEvent](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L55-L58>)
...
## type [PublicationAuthority](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L96>)
...
## type [PublicationConfig](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L193-L202>)
...
## type [PublishedRecord](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L119-L127>)
...
## type [RegistryClient](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L468-L501>)
...
## type [RegistryClientControlledPublisher](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L454-L457>)
...
## type [RegistryClientOption](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L529>)
...
### func [WithAuthToken](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L532>)
...
### func [WithInsecureHTTP](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L544>)
...
### func [WithRegistryHTTPClient](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L537>)
...
## type [RegistryPreparedEventClient](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L461-L465>)
...
## type [RegistryPublisher](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L447-L450>)
...
## type [RegistryRegistrationReader](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L441-L443>)
...
## type [RegistryRevocationReason](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L340>)
...
## type [RegistryStatusReader](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L518-L520>)
...
## type [RetireAgentRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L364-L366>)
...
## type [RevokeAgentRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L358-L361>)
...
## type [SignatureRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L272-L274>)
...
## type [SignatureResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L286-L292>)
...
## type [SubmissionResult](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L76-L83>)
...
## type [SubmissionState](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L61>)
...
<a name="TXTRecord"></a>
## type [VerifyDomainRequest](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L411-L413>)
...
## type [VerifyDomainResponse](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L416-L426>)
...
## type [WaitForStatusOptions](<https://github.com/dnsid-ai/dnsid-go/blob/main/registry.go#L523-L526>)
